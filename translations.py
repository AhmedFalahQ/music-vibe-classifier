...
UI = {
    ...
    "ar": {
        ...
        "brand": "Image2Genre",
        "model_chip": "ResNet34 · 5 فئات",
        "lang_other": "EN",
        "lang_other_label": "التبديل إلى الإنجليزية",
        "new_image": "صورة جديدة",

        "hero_eyebrow": "من الصورة إلى الصوت",
        "hero_title": "أرِني صورة.\nسأجد لك\nالموسيقى فيها.",
        "hero_body": "يقرأ نموذج ResNet34 ألوان صورتك وضوءها وملمسها، ويختار النوع الموسيقي الذي يطابق مزاجها — ثم يُريك أي جزء من الإطار غيّر رأيه.",
        "five_vibes": "خمسة أنواع محتملة",
        ...
        "step_1_sub": "تغيير الحجم إلى 224² وتطبيع ImageNet",
        "step_2": "تصنيف الطابع",
        "step_2_sub": "تمريرة أمامية عبر ResNet34 على 5 أنواع",
        "step_3": "تحديد مواضع التركيز",
        "step_3_sub": "Grad-CAM على آخر كتلة التفاف",
