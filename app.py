...
try:
    YOUTUBE_API_KEY = dict.get(json.loads(get_secret('your secret name')),'your key name') # Change it with your actual values
    secrets=json.loads(get_secret("your-secret-name")) # Change it with your actual values
    bucket_name=secrets.get("your key name") # Change it with your actual values
    lambda_function_name=secrets.get("your key name") # Change it with your actual values
except:
    # Fallback for local development
    YOUTUBE_API_KEY = os.getenv("your key name") # Change it with your actual values
    bucket_name=os.getenv("your key name") # Change it with your actual values
    lambda_function_name=os.getenv("your key name") # Change it with your actual values

PLAYLIST_MAP = { # a map for playlist IDs of original and khaleeji songs for each genre
    "classical": {
        "original": "your playlist ID",  # Change it with your actual values
        "khaleeji": "your playlist ID"   # Change it with your actual values
    },
    "pop": {
        "original": "your playlist ID",   # Change it with your actual values
        "khaleeji": "your playlist ID"    # Change it with your actual values
...
model.eval()
label_encoder = joblib.load("label_encoder.pkl") # loading the labels to map later
